...
namespace Fit
{
	public partial class ProfileViewController : UITableViewController, IHealthStore
	{
		...
		private NSSet DataTypesToWrite {
			get {
		...
		private void UpdateUsersHeight ()
		{
		...
		private void UpdateUsersWeight ()
		{
		...
		private void SaveHeightIntoHealthStore (double value)
		{
		...
		private void SaveWeightIntoHealthStore (double value)
		{
