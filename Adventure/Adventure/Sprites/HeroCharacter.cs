...
namespace Adventure
{
	public abstract class HeroCharacter : Character
	{
		...
		private float HeroProjectileLifetime = 1; // 1.0 seconds until the projectile disappears
		private float HeroProjectileFadeOutTime = 0.6f; // 0.6 seconds until the projectile starts to fade out
		...
		protected HeroCharacter (PointF position, Player player)
			: this (null, position, player)
		{
		}

		protected HeroCharacter (SKTexture texture, PointF position, Player player)
